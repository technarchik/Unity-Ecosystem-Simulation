...
public class Genome
{
    ...
    public static Genome CreateGenome(AnimalType type)
    {
        ...
        {
            genome.speed = Random.Range(2f, 5f);
            genome.maxStamina = Random.Range(1f, 3f);
            genome.sightRange = Random.Range(5, 12);

            genome.hungerDecreasingSpeed = Random.Range(0.5f, 1.0f);
            genome.thirstDecreasingSpeed = Random.Range(0.5f, 1.0f);
            ...
            genome.tempResist = Random.Range(0.1f, 5f);
